...
export function InvestorsHero() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-blue-900 via-emerald-900 to-gray-900 text-white pt-24">
      <div className="absolute inset-0 bg-grid-white/5 [mask-image:linear-gradient(0deg,transparent,rgba(255,255,255,0.1))]" />
      
      <div className="container mx-auto px-6 md:px-12 lg:px-24 xl:px-[200px] py-32 md:py-40 relative">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-emerald-50 mb-10 leading-relaxed max-w-4xl mx-auto">
            Quis delivers efficient risk-adjusted returns through a diverse exposure to market-rate returns 
            while investing in impact
          </p>
