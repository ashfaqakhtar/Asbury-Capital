...
export function FundedLoansHero() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-blue-900 via-emerald-900 to-gray-900 text-white">
      ...
      <div className="container mx-auto px-4 py-32 md:py-40 relative">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-emerald-50 mb-10 leading-relaxed max-w-4xl mx-auto">
            Explore our portfolio of successfully funded real estate projects across diverse 
